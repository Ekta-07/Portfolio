        ...
        <div className="min-h-screen bg-[#0B0C14] text-white">
            ...
            <main className="pt-24 pb-20">
                <div className="max-w-4xl mx-auto px-6">
                    ...
                    {/* Contact Info */}
                    <div className="bg-gradient-to-br from-[#171926] to-[#0B0C14] border border-[#727DA1]/15 rounded-2xl p-8 md:p-12 mb-12">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            {/* Location */}
                            <div className="flex items-start gap-4">
                                <div className="w-12 h-12 rounded-full bg-[#818CF8]/20 flex items-center justify-center flex-shrink-0">
                                ...
                                <div>
                                    ...
                                    <p className="text-[#939DB8]">{personal.location}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                            <a
                                ...
                                className="flex flex-col items-center gap-3 p-6 bg-[#171926] border border-[#727DA1]/15 rounded-xl hover:border-[#6366F1]/40 transition-all hover:shadow-xl hover:shadow-[#6366F1]/10"
                            >
