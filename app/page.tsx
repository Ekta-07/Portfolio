...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#0B0C14] text-[#C9D3EE]">
          ...
          <div className="text-center space-y-6">
            ...
            <div className="flex justify-center gap-3">
              <a href={personal.social.github} target="_blank" rel="noopener noreferrer"
                className="p-2.5 bg-[#171926]/80 hover:bg-[#1E2133] rounded-full transition-all border border-[#727DA1]/15 backdrop-blur-sm hover:border-[#6366F1]/30" aria-label="GitHub">
              ...
              <a href={personal.social.linkedin} target="_blank" rel="noopener noreferrer"
                className="p-2.5 bg-[#171926]/80 hover:bg-[#1E2133] rounded-full transition-all border border-[#727DA1]/15 backdrop-blur-sm hover:border-[#6366F1]/30" aria-label="LinkedIn">
              ...
              <a href={personal.social.twitter} target="_blank" rel="noopener noreferrer"
                className="p-2.5 bg-[#171926]/80 hover:bg-[#1E2133] rounded-full transition-all border border-[#727DA1]/15 backdrop-blur-sm hover:border-[#6366F1]/30" aria-label="Twitter">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" /></svg>
              </a>
              <a href={personal.social.medium} target="_blank" rel="noopener noreferrer"
                className="p-2.5 bg-[#171926]/80 hover:bg-[#1E2133] rounded-full transition-all border border-[#727DA1]/15 backdrop-blur-sm hover:border-[#6366F1]/30" aria-label="Medium">
            ...
            <div className="flex flex-wrap gap-3 justify-center pt-2">
              <Link
                href="/contact"
                className="px-7 py-3 bg-gradient-to-r from-[#6366F1] to-[#4F46E5] text-white hover:from-[#818CF8] hover:to-[#6366F1] rounded-lg font-medium transition-all text-sm shadow-lg shadow-[#6366F1]/20"
              >
                Contact me here →
              </Link>
              <Link
                href="/work"
                className="px-7 py-3 bg-[#171926]/60 hover:bg-[#1E2133] rounded-lg font-medium transition-all text-sm border border-[#727DA1]/15 text-[#C9D3EE] backdrop-blur-sm"
              >
                View My Work
              </Link>
            </div>
      ...
      {/* Featured Projects */}
      <section className="pt-24 pb-8 bg-[#0B0C14]">
      ...
      <section className="pt-8 pb-24 bg-[#0B0C14]">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="bg-[#171926] border border-[#727DA1]/15 rounded-xl p-6 mb-8">
      ...
      {/* Writings & Art */}
      <section className="py-24 bg-[#0E0F1A]">
        <div className="max-w-6xl mx-auto px-6">
          <div className="flex items-center gap-3 mb-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div>
              ...
              <div className="space-y-3">
                {blogs.map((blog) => (
                  <a key={blog.id} href={blog.url} target="_blank" rel="noopener noreferrer"
            ...
            <div>
              ...
              <div className="space-y-3">
                {artPieces.map((art) => (
                  <div key={art.id} className="group overflow-hidden rounded-xl bg-[#171926] border border-[#727DA1]/10 hover:border-[#6366F1]/25 transition-all">
